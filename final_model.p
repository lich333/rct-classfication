{
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "oE4ZM0K8vd7f",
        "outputId": "3bee11f7-2fda-499f-ba9c-d8fadf652b00"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "MQbX0wIewg1M",
        "outputId": "a36480ae-8c7b-4177-cef9-b79e7141f4d2"
      },
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-38f8b355-2e9b-4c31-b87a-b1e7ea4647aa\">\n",
              ...
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-38f8b355-2e9b-4c31-b87a-b1e7ea4647aa')\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-38f8b355-2e9b-4c31-b87a-b1e7ea4647aa button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-38f8b355-2e9b-4c31-b87a-b1e7ea4647aa');\n",
              "          const dataTable =\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "hBESZYrW8lnT",
        "outputId": "83a58cb6-9d56-4c57-b333-44efeb4bcbe5"
      },
      "outputs": [
        {
          "output_type": "execute_result",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "btVVRQgS9Eex",
        "outputId": "a9285d9a-3543-48b0-b51f-92d997954eac"
      },
      "outputs": [
        {
          "output_type": "execute_result",
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-3f4096f3-23fe-431f-be4a-e97c60f48998\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-3f4096f3-23fe-431f-be4a-e97c60f48998')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-3f4096f3-23fe-431f-be4a-e97c60f48998 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-3f4096f3-23fe-431f-be4a-e97c60f48998');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "qDBg5wjJ9nU5",
        "outputId": "cf2916b6-f566-4317-d339-d17cab1c33f1"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "2eihjkNG9u0s",
        "outputId": "ba79a66b-b527-4005-c22f-4d83dca507fb"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "33xIa3-n-eQt",
        "outputId": "186527bb-b1d3-4d97-d669-6e5db3be04ec"
      },
      "outputs": [
        {
          "output_type": "execute_result",
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-2313b00b-9f79-429d-80b1-c863faa4f1e8\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-2313b00b-9f79-429d-80b1-c863faa4f1e8')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-2313b00b-9f79-429d-80b1-c863faa4f1e8 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-2313b00b-9f79-429d-80b1-c863faa4f1e8');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "IYMJhywp-jkO",
        "outputId": "25920ece-9211-4763-f078-ff3f07011e24"
      },
      "outputs": [
        {
          "output_type": "execute_result",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "MP0aKmV5__7U",
        "outputId": "3bf6c23c-c449-41f5-f973-b6fb21341769"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "u3LgGW1nAR3B",
        "outputId": "497b66ec-232b-4811-d915-eadfa6fa9141"
      },
      "outputs": [
        {
          "output_type": "execute_result",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ycyVkcuTBE9T",
        "outputId": "382dc725-014c-4d99-eb87-b9da69be80fb"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "yBK3lMxCB6z8",
        "outputId": "9d0e4f67-ae5c-4476-95a9-fdf80ad57505"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "xtosfP3vCTKk",
        "outputId": "d9fd1f5f-bbb8-4c3e-9105-19bd5f53ba4d"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "tdJEjB1BDfkP",
        "outputId": "e8473f41-39b8-43b3-981d-3bfabcdef4cb"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "source": [
        "import pickle\n",
        "xgb_model = open(\"final_model.p\",\"wb\")\n",
        "pickle.dump(xgb_clf,xgb_model)\n",
        "xgb_model.close()\n"
      ]
    },
    {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ZAbdqzFoFPCx",
        "outputId": "68a2ce94-5967-4781-b0a6-1febc124db62"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "9JUMaN1jFtzL",
        "outputId": "8fc769b7-c6ad-43c5-c862-745de46d7145"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "AtiO8nd_F9XW",
        "outputId": "f2356872-dfc2-4220-d110-a15811c6a0fc"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "vTcdIhhUGBJz",
        "outputId": "acc1850b-5fca-4e62-cccc-bb1ddce8de2e"
      },
      "outputs": [
        {
          "output_type": "stream",
        ...
        },
        {
          ...
          "name": "stderr",
          "text": [
            "t=2022-07-02T07:29:53+0000 lvl=warn msg=\"failed to start tunnel\" pg=/api/tunnels id=4389e1c45ac8ccb3 err=\"Your account may not run more than 2 tunnels over a single ngrok agent session.\\nThe tunnels already running on this session are:\\ntn_2BNVqcAxZuJVdEElamNFiCezkJT, tn_2BNVqeYyjK7Lsd0jJFeYb0mtRl6\\n\\r\\n\\r\\nERR_NGROK_324\\r\\n\"\n",
            "\n"
          ]
        },
        {
  ...
  "metadata": {
    "colab": {
      ...
      "authorship_tag": "ABX9TyNjdfixZDrymh/5BNGWsODh",
