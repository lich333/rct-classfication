{
  ...
  "metadata": {
    "colab": {
      ...
      "authorship_tag": "ABX9TyOJ47jOEjQEdYxGcEXKPzoi",
  ...
  "cells": [
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "oE4ZM0K8vd7f",
        "outputId": "c1700885-57be-49e6-ab52-cc8e7cb30dde"
      },
      "outputs": [
        {
          "output_type": "stream",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "MQbX0wIewg1M",
        "outputId": "30cdea46-c595-423b-e7b2-5289a27c43a6"
      },
      "execution_count": 56,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-0fc3d82b-11ce-49a9-9897-2b67b02a963b\">\n",
              ...
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-0fc3d82b-11ce-49a9-9897-2b67b02a963b')\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-0fc3d82b-11ce-49a9-9897-2b67b02a963b button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-0fc3d82b-11ce-49a9-9897-2b67b02a963b');\n",
              "          const dataTable =\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "hBESZYrW8lnT",
        "outputId": "cc53a38f-9d11-41bb-a74c-5dad13dcf2e5"
      },
      "execution_count": 59,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "btVVRQgS9Eex",
        "outputId": "b7cdbd83-6dd0-4bb3-9da3-1e2cf3946dda"
      },
      "execution_count": 64,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-a27c0d92-5240-4886-a48f-dda68d7f1976\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-a27c0d92-5240-4886-a48f-dda68d7f1976')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-a27c0d92-5240-4886-a48f-dda68d7f1976 button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-a27c0d92-5240-4886-a48f-dda68d7f1976');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "qDBg5wjJ9nU5",
        "outputId": "523feaa0-1317-43d9-9602-4263b3226fa2"
      },
      "execution_count": 66,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "2eihjkNG9u0s",
        "outputId": "341d7665-eca8-4c82-fba1-4e0331ba0302"
      },
      "execution_count": 67,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "33xIa3-n-eQt",
        "outputId": "eeee2026-b197-40d9-ed0f-0f5964c76561"
      },
      "execution_count": 68,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-916d3a24-99d9-454e-b045-f489b7d2ef0c\">\n",
              "    <div class=\"colab-df-container\">\n",
              "      <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              ...
              "</div>\n",
              "      <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-916d3a24-99d9-454e-b045-f489b7d2ef0c')\"\n",
              "              title=\"Convert this dataframe to an interactive table.\"\n",
              "              style=\"display:none;\">\n",
              "        \n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "      <script>\n",
              "        const buttonEl =\n",
              "          document.querySelector('#df-916d3a24-99d9-454e-b045-f489b7d2ef0c button.colab-df-convert');\n",
              "        buttonEl.style.display =\n",
              "          google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "        async function convertToInteractive(key) {\n",
              "          const element = document.querySelector('#df-916d3a24-99d9-454e-b045-f489b7d2ef0c');\n",
              "          const dataTable =\n",
              "            await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                     [key], {});\n",
              "          if (!dataTable) return;\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "IYMJhywp-jkO",
        "outputId": "50ac7274-2351-439c-f00b-bcf75dedfe9f"
      },
      "execution_count": 69,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "MP0aKmV5__7U",
        "outputId": "7b203560-01b9-406c-cd85-992b3a5b08b6"
      },
      "execution_count": 70,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "u3LgGW1nAR3B",
        "outputId": "51fce903-c754-44bb-e5fb-d33f57f81450"
      },
      "execution_count": 71,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ycyVkcuTBE9T",
        "outputId": "1f6362c9-11a5-46a6-95b1-bbb5ae8a7c49"
      },
      "execution_count": 73,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "yBK3lMxCB6z8",
        "outputId": "0fa6c2fe-b623-4b34-f5b0-6b8fc2e45bc5"
      },
      "execution_count": 74,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "xtosfP3vCTKk",
        "outputId": "a460273f-312d-4edb-a57d-f625a441f6d2"
      },
      "execution_count": 75,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "tdJEjB1BDfkP",
        "outputId": "b1835dac-f4e0-450f-8f4c-0222d9c6b1fe"
      },
      "execution_count": 76,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "oGTxdFixTzj4",
        "outputId": "5f3e2373-8250-411f-bd6b-56743df6f737"
      },
      "execution_count": 85,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ZAbdqzFoFPCx",
        "outputId": "4b0869c9-04f1-45d8-c020-e32ac3702669"
      },
      "execution_count": 86,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "9JUMaN1jFtzL",
        "outputId": "ce42f312-b6df-4966-c7ea-cc14ae0238d9"
      },
      "execution_count": 87,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "AtiO8nd_F9XW",
        "outputId": "06695fb9-0b09-461c-b493-8a5a195f4ae9"
      },
      "execution_count": 88,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "vTcdIhhUGBJz",
        "outputId": "73fdbcc5-8586-41c7-ae34-9b46d0fbf467"
      },
      "execution_count": 89,
      "outputs": [
        {
        ...
        },
        {
          ...
          "data": {
            "text/plain": [
              "'http://1bb8-34-72-86-107.ngrok.io'"
            ],
